...
public class HttpServer1 {
    ...
    public HttpServer1(int port) throws IOException {
    ...
    private void process(Socket clientSocket) {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
            ...
            } else if (url.equals("/guapi")) {
                bufferedWriter.write(version + " 303 See Other\n");
                bufferedWriter.write("Location: http://www.bilibili.com\n");
                resp = "";
            } else {
                bufferedWriter.write(version + " 200 OK\n");
                resp = "<h1>default</h1>";
    ...
    public static void main(String[] args) throws IOException {
        HttpServer1 server = new HttpServer1(9090);
        server.start();
    }
}